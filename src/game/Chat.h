...
class MANGOS_DLL_SPEC ChatHandler
{
    public:
        ...
        static void FillMessageData( WorldPacket *data, WorldSession* session, uint8 type, uint32 language, const char *channelName, ObjectGuid targetGuid, const char *message, Unit *speaker, bool forceGMIcon = false);
    ...
    protected:
        ...
        bool HandleArenaQueueCommand(char * args);
