...
enum SpellModOp
{
    ...
    SPELLMOD_CRIT_DAMAGE_BONUS_2    = 29,                    // used by single test spell 45365
...
class MANGOS_DLL_SPEC Unit : public WorldObject
{
    public:
        ...
        SpellAuraProcResult HandleIgnoreAuraStateProc(Unit *pVictim, uint32 damage, Aura* triggeredByAura, SpellEntry const *procSpell, uint32 procFlag, uint32 procEx, uint32 cooldown);
        ...
        uint32 CalculateAuraPeriodicTimeWithHaste(SpellEntry const* spellProto, uint32 periodicTime, SpellEffectIndex eff);
