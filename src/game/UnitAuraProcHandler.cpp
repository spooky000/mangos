    ...
    switch(dummySpell->SpellFamilyName)
    {
        ...
        case SPELLFAMILY_MAGE:
        {
            ...
            switch(dummySpell->Id)
            {
                ...
                case 56374:
                {
                    pVictim->RemoveSpellsCausingAura(SPELL_AURA_MOD_MELEE_HASTE);
                    pVictim->RemoveSpellsCausingAura(SPELL_AURA_HASTE_SPELLS);
...
SpellAuraProcResult Unit::HandleAddFlatModifierAuraProc(Unit* pVictim, DamageInfo* damageInfo, Aura* triggeredByAura, SpellEntry const * procSpell, uint32 /*procFlag*/, uint32 /*procEx*/, uint32 /*cooldown*/)
{
    ...
    switch (spellInfo->Id)
    {
        ...
        case 53695:   // Judgements of the Just
        case 53696:
        {
            if (!procSpell)
                return SPELL_AURA_PROC_FAILED;
