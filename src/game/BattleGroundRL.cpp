...
void BattleGroundRL::HandleAreaTrigger(Player *Source, uint32 Trigger)
{
    ...
    switch(Trigger)
    {
        ...
        case 4941:                                          // Falling down
            Source->TeleportTo(GetMapId(), Source->GetPositionX(), Source->GetPositionX(), (Source->GetTerrain()->GetHeight(Source->GetPositionX(), Source->GetPositionY(), MAX_HEIGHT) + 3), Source->GetOrientation());
            break;
        default:
